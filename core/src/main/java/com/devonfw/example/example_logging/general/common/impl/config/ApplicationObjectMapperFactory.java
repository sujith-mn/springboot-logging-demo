package com.devonfw.example.example_logging.general.common.impl.config;
...
/**
 * The MappingFactory class to resolve polymorphic conflicts within the example-logging application.
 */
