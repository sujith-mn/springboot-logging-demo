package com.devonfw.example.example_logging;
...
@EntityScan(basePackages = { "com.devonfw.example.example_logging" }, basePackageClasses = { AdvancedRevisionEntity.class })
